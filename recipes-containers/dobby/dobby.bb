...
SRC_URI:append:scarthgap = " file://Add_config_header_kirkstone.patch \
                           "
...
DEPENDS:append:scarthgap = " autoconf-native automake-native "
CFLAGS:append:scarthgap = " --sysroot=${RECIPE_SYSROOT}"
