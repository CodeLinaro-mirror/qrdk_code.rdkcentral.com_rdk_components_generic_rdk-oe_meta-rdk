...
RDEPENDS:packagegroup-rdk-oss-broadband = "\
    ...
    dibbler-client \
    dibbler-server \
    ${@bb.utils.contains("DISTRO_FEATURES", "kirkstone wrynose", "", "dhcp-client", d)} \
    ${@bb.utils.contains("DISTRO_FEATURES", "kirkstone wrynose", "", "dhcp-server",  d)} \
    ${@bb.utils.contains("DISTRO_FEATURES", "kirkstone wrynose", "",  "dhcp-server-config", d)} \
    dnsmasq \
    dropbear \
    expat \
    ez-ipupdate \
