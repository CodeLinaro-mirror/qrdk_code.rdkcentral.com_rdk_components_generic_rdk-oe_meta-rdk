...
RDEPENDS:packagegroup-rdk-ccsp-broadband:remove_tchxb8 = " ccsp-tr069-pa ccsp-tr069-pa-ccsp"
...
RDEPENDS:packagegroup-rdk-ccsp-broadband += " ${@bb.utils.contains('DISTRO_FEATURES', 'dhcp_manager', 'ccsp-dhcp-mgr', '', d)}"
