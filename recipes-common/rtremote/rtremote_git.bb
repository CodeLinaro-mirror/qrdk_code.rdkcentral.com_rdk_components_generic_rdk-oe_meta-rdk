...
ARCHFLAGS:append_arm = "${@bb.utils.contains('TUNE_FEATURES', 'callconvention-hard', '--with-arm-float-abi=hard', '--with-arm-float-abi=softfp', d)}"
ARCHFLAGS:append_mipsel = " --with-mips-arch-variant=r1"
ARCHFLAGS ?= ""
